...
public class MainActivity extends AppCompatActivity {
    ...
    String[] fromLanguages={"From","English","Afrikaans","Arabic","Belarusian","Bulgarian","Bengali","Catlan","Czech",
     "Welsh","Hindi","Urdu"};
    String[] toLanguages={"To","English","Afrikaans","Arabic","Belarusian","Bulgarian","Bengali","Catlan","Czech",
            "Welsh","Hindi","Urdu"};
...
//        fromSpinner.setOnItemSelectedListener();Listener(new AdapterView.OnItemSelectedListener() {
//            @Override
//            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
//                fromLanguageCode = getLanguageCode(fromLanguages[position]);
//            }
        ...
        translateBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (sourceEdit.getText().toString().isEmpty()) {
                    ...
                    Toast.makeText(MainActivity.this, "Please select source language translate", Toast.LENGTH_SHORT).show();
